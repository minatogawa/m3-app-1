...
class Form1(Form1Template):
  ...
  def my_button_click(self, **event_args):
    if self.loaded_file:
      ...
      # Cria um FlowPanel para conter o DataGrid e aplicar a rolagem horizontal
      flow_panel = FlowPanel()
      flow_panel.role = 'flow-scroll-x'
      flow_panel.add_component(grid)
        
      # Adicionando o FlowPanel ao painel de conteúdo do formulário
      self.content_panel.add_component(flow_panel)
